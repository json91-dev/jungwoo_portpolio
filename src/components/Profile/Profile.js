      ...
      <div className="w-[80%] pl-5 text-gray-700 ">
        ...
        <div className="flex flex-col h-[80%] ">
          <div className="flex flex-row items-center ml-[1.4rem] mt-[1.3rem]">
            ...
            <a className='ml-[1.5rem] text-blue-500 text-2xl' href="mailto:jjjjjw910911@gmail.com" target="_blank">jjjjjw910911@gmail.com</a>
          </div>

          <div className="flex flex-row items-center ml-[1.4rem] mt-[1.3rem]">
            <img className='object-cover h-[1.5rem]' src={phoneImg}/>
            <a className='ml-[1.5rem] text-2xl'>010-6284-8051</a>
          </div>

          <div className="flex flex-row items-center ml-[1.4rem] mt-[1.3rem]">
            <img className='object-cover h-[1.5rem]' src={githubImg}/>
            <a className='ml-[1.5rem] text-blue-500 text-2xl' href='https://github.com/jungwoole91' target="_blank">https://github.com/jungwoole91</a>
          </div>

          <div className="flex flex-row items-center ml-[1.4rem] mt-[1.3rem]">
            <img className='object-cover h-[1.5rem]' src={rssImg}/>
            <a className='ml-[1.5rem] text-blue-500 text-2xl' href='https://jw910911.tistory.com' target="_blank">https://jw910911.tistory.com</a>
          </div>
        </div>
      </div>
    </div>
