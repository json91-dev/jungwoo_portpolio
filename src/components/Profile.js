      ...
      <div className="w-[80%] pl-5 text-gray-700 ">
        <div className="text-lg h-[20%]">
          <p className="text-5xl text-blue-600">
            이정우 <font className="text-3xl">(Jungwoo Lee)</font>{" "}
          </p>
        </div>
        <div className="flex flex-col h-[80%] ">
          <div className="flex flex-row items-center ml-[1.4rem] mt-[1.3rem]">
            ...
            <a
              className="ml-[1.5rem] text-blue-500 text-2xl"
              href="mailto:jjjjjw910911@gmail.com"
              target="_blank"
            >
              jjjjjw910911@gmail.com
            </a>
          </div>
          ...
          <div className="flex flex-row items-center ml-[1.4rem] mt-[1.3rem]">
            ...
            <a
              className="ml-[1.5rem] text-blue-500 text-2xl"
              href="https://github.com/jungwoole91"
              target="_blank"
            >
              https://github.com/jungwoole91
            </a>
          </div>
          ...
          <div className="flex flex-row items-center ml-[1.4rem] mt-[1.3rem]">
            ...
            <a
              className="ml-[1.5rem] text-blue-500 text-2xl"
              href="https://jw910911.tistory.com"
              target="_blank"
            >
              https://jw910911.tistory.com
            </a>
          </div>
        </div>
      </div>
